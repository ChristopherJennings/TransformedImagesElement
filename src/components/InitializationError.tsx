...
export class InitializationError extends React.Component<IErrorProps> {
    ...
    render() {
        const sampleParameters: IRequiredConfig = {
            contentManagementEndpoint: "<Endpoint URL providing an asset listing response for the project. See https://developer.kenticocloud.com/docs/sensitive-information-for-custom-elements for more.>",
